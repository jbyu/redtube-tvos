...
<stackTemplate theme="dark" class="darkBackgroundColor">
    ...
    <row id="buttons">
        <buttonLockup id="newest" request="/">
        <badge src="resource://button-cloud" />
        <title>Newest</title>
        </buttonLockup>
        <buttonLockup id="rated" request="/top/">
        <badge src="resource://star_mask_l" />
        <title>Top Rated</title>
        </buttonLockup>
        <buttonLockup id="viewed" request="/mostviewed/">
        <badge src="resource://button-preview" />
        <title>Most Viewed</title>
        </buttonLockup>
        <buttonLockup id="favored" request="/recommended/">
...
var Request = function(arg) {
    ...
    xhr.onload = function () {
        ...
        doc.getElementById("title").innerHTML = "Redtube"+orig;
        ...
        lsInput.stringData = `<buttonLockup id="newest" request="/">
        <badge src="resource://button-cloud" />
        <title>Newest</title>
        </buttonLockup>
        <buttonLockup id="rated" request="/top/">
