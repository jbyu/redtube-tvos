...
<document>
  ...
  <stackTemplate>
    ...
    <overlay style="padding:0;">
            <title style="tv-position: bottom-right;">Title</title>
    ...
    <overlay style="padding:0;">
    <title>Title</title>
    <subtitle  style="tv-position: bottom-right;">Subtitle</subtitle>
    <subtitle>Subtitle 2</subtitle>
    <description>description</description>
    <badge src="resource://button-add" />
    </overlay>
    ...
    <img src="${this.BASEURL}resources/images/iceland/iceland_11_square.jpg" width="308" height="308" />
    <title>Title</title>
    <overlay style="padding:0;width:100;">
    <title></title>
    <description class="overlayTextLayout">description</description>
    </overlay>
    </lockup>
